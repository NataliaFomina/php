...
if (!empty($_POST)) {
  ...
  if ($_POST['userName'] !== '' && (count($_POST)-2) === count($json['questions'])) {
    $allAnswers = true;
  } else {
    $message = 'Введите имя и ответьте на все вопросы';
  }
  // print_r($result);
}
...
<?php foreach($result as $item) { ?>
  ...
  <?php } ?>
  <img src="img.php?name=<?php echo $_POST['userName']?>&result=<?php echo '5 баллов'?>" alt="">
<?php } else { ?>
